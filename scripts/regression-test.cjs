...
async function runTests() {
  ...
  try {
    ...
    console.log(`[1/6] Creating temporary test user: ${testEmail}...`);
    ...
    console.log('[3/6] Seeding test preferences...');
    ...
    console.log('[4/6] Invoking remote generate-trip-digest edge function (mock: true)...');
    ...
    console.log('[5/6] Invoking remote generate-stock-digest edge function (mock: true)...');
    ...
    // 6. Teardown
    if (testUser) {
      console.log('[6/6] Cleaning up test user and cascading database rows...');
